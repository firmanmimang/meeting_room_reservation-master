...
<section class="section">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="/internal/cv/store" method="post">
                        <?= csrf_field(); ?>
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nama" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : '' ?>" id="nama" value="" placeholder="nama">
...
<!-- Phone Number                       -->
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="no_hp" class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : '' ?>" id="no_hp" value="" placeholder="nomor hp">
                                <div class="invalid-feedback font-size-invalid-feedback">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-5">
                                <input type="text" name="tempat_lahir" class="form-control <?= ($validation->hasError('tempat_lahir')) ? 'is-invalid' : '' ?>" id="tempat_lahir" value="" placeholder="tempat lahir">
                                <div class="invalid-feedback font-size-invalid-feedback">
                                    <?= $validation->getError('tempat_lahir') ?>
                                </div>
                            </div>
                            <div class="col-sm-5">
                                <input type="date" name="tanggal_lahir" class="form-control <?= ($validation->hasError('tanggal_lahir')) ? 'is-invalid' : '' ?>" id="tanggal_lahir" value="" placeholder="tanggal lahir">
                                <div class="invalid-feedback font-size-invalid-feedback">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="agama" class="form-control <?= ($validation->hasError('agama')) ? 'is-invalid' : '' ?>" id="agama" value="" placeholder="agama">
                                <div class="invalid-feedback font-size-invalid-feedback">
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : '' ?>" id="alamat" rows="4" name="alamat" placeholder="masukan alamat"></textarea>
                                <div class="invalid-feedback font-size-invalid-feedback">
